...
export const pages = [
  ...
  // ============================================================
  {
    ...
    type: "diagnostico",
    title: "Diagnóstico PBQP-H · Templum",
    metaDescription: "Diagnóstico gratuito da prontidão da sua construtora para o PBQP-H (SiAC): nível estimado, gaps e próximo passo até a certificação.",
    headlineHtml: "Em 5 minutos,<br>veja em que <em>nível</em><br>sua obra está.",
    subhead: "Responda sobre canteiro, documentos e rotina. O diagnóstico aponta o nível mais realista (D a A) e o que falta para chegar na Caixa.",
    ...
    benefits: [
      "<strong>Nível estimado</strong> (D, C, B ou A) com base na rotina real.",
      "Os <strong>3 gaps</strong> que mais travam a auditoria.",
      "Leitura de <strong>PQO, serviços, materiais e evidência</strong> no canteiro.",
      "Próximo passo para <strong>certificar sem teatro de pasta</strong>.",
    ],
    marqueeItems: ["PBQP-H", { text: "Diagnóstico", orange: true }, "SiAC", { text: "Nível D a A", orange: true }, "Caixa", { text: "Canteiro", orange: true }],
    steps: [
      { num: "01", title: "Sistema vivo", text: "Se o procedimento existe só na pasta, o simulador puxa isso para baixo." },
      { num: "02", title: "PQO por obra", text: "Plano de Qualidade da Obra preenchido, com dono, não modelo genérico." },
      { num: "03", title: "Serviços controlados", text: "Critério de aceitação e registro no canteiro, não só no escritório." },
      { num: "04", title: "Materiais e fornecedores", text: "Recebimento, rastreio e quem entra na obra sem avaliação." },
      { num: "05", title: "Gente e NC", text: "Competência registrada e não conformidade que não se repete." },
      { num: "06", title: "Pronto para o auditor", text: "Evidência achável amanhã, sem caçar WhatsApp." },
    ],
    ctaTitle: "PBQP-H é o <em>passaporte</em><br>pro crédito da Caixa.",
    ctaCopy: "Sem certificação, sua construtora fica de fora dos principais programas habitacionais. O diagnóstico mostra o caminho mais curto para entrar, com o que falta hoje.",
    ctaItems: ["Aplicável a construtoras de todos os portes", "Não é auditoria SiAC: é raio-x para priorizar", "Sem custo · sem compromisso"],
    faqItems: [
      { q: "Isso vale como auditoria?", a: "Não. É um simulador para você ver o recorte da obra. A certificação continua com organismo certificador, no regimento SiAC vigente." },
